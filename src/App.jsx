...
function groupByWorkblock(tasks, calendarWorkblocks) {
  ...
  // Build the order map: prefer calendar (dynamic), fall back to static.
  let orderMap;
...
export default function App() {
  ...
  // Split tasks into today vs hanging (carry-over).
      ...
      >
        ...
        {mode === "triage" ? (
          ...
          <>
            ...
            {isEmptyDay ? (
              // Carry-over render: hanging tasks in a single group, no workblock cards
